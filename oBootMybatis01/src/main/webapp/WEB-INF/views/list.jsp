...
<body>
	...
	<a href="writeFormEmp3">writeFormEmp Valid 입력</a>
	<h3>사원수 : ${totalEmp}</h3>
	<p>upCnt 수정시 전달 Message : ${upCnt}</p>
	...
	<c:if test="${page.startPage > page.pageBlock}">
		<a href="list?currentPage=${page.startPage-page.pageBlock }">[이전]</a></c:if>
	...
	<c:set var="num" value="${ page.toal - page.start + 1 }"></c:set>
	...
	<c:if test="${page.endPage < page.totalPage}">
		<a href="empList?currentPage=${page.startPage + page.pageBlock}">[다음]</a>
	</c:if>
	 --%>
</body>
</html>