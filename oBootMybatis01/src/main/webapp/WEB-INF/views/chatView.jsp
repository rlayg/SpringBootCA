...
<script type="text/javascript">
	...
	function wsOpen(){
        ...
        var wsUri  = "ws://" + location.host + "${pageContext.request.contextPath}/chatting"; // 부트로 들어오면 루트야 근데 혹시 몰라서 ${pageContext.request.contextPath} 집어넣음 war로 배포할때 대비
    ...
    function  wsEvt() {
       ...
       ws.onmessage = function(data) {
			...
			if(msg != null && msg.trim() != ''){
				...
				// msg가 배열이고, 2개이상의 Count이면 , member 등록 대상 	/ 한사람이냐 두사람이냐 계산하는거
